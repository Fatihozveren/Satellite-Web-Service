...
<head>
    ...
    <link rel="stylesheet" href="{{asset('front/css/styleV1.css')}}">
    ...
    <style>
        ...
        .loginDiv{
            ...
            box-shadow: 0 0 14px 0px #00000040;
            padding: 30px;
            display: flex;
            gap: 30px;
        }
        ...
        .btn-6 span:hover{
            ...
            background: linear-gradient(to right, #B294FF, #57E6E6, #172d41, #57E6E6, #B294FF, #57E6E6);
...
<body>
    ...
    <div class="loginDiv">
        ...
        <form method="post" action="{{route('education.login_post')}}">
            @csrf
            <div class="inputDiv">
                <div class="user-mail inpgroup w-100">
                ...
                <button type="submit" class="custom-btn btn-6 login-button"><span>Giriş Yap</span></button>
        </form>
        </div>
    </div>
</body>
