...
<aside>
    ...
    <ul>
        <li class="active"><a href=""><i class="fa-light fa-house-user"></i><span>Ana Sayfa</span></a></li>
        <li><a href="{{route('education.classes')}}"><i class="fa-solid fa-school"></i><span>Sınıflarım</span></a></li>
        <li><a href="{{route('education.requests')}}"><i class="fa-regular fa-lock"></i><span>Kilit İsteklerim</span></a></li>
        <li><a href=""><i class="fa-regular fa-screen-users"></i><span>Tüm Öğrencilerim</span></a></li>
        <li><a href="{{route('education.class.list')}}"><i class="fa-solid fa-book"></i></i><span>Sınıf Eğitim Atama</span></a></li>
